export const Components = {
    // Генерация Сайдбара с учетом ролей
    renderSidebar(role) {
        const sidebar = document.getElementById('sidebar');
        
        // Массив всех возможных ссылок в системе
        const menuItems = [
            ...
            { id: 'driver', label: 'Заявки водителя', icon: 'fa-truck-ramp-box', roles: ['Администратор', 'Водитель'] },
